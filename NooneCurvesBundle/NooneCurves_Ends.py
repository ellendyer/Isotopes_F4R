...
plot_file = 'Plot_noone_curves.pdf'    # default file name for plots
...
del0 = -400.    # Try -360 ....
delp = -30.     # put delp = 0 to have curve go up to deld = 0
eta  = 0.995
hsrc = 0.80 
...
#
  ...
  print ("tsrc,dels,qs = ",tsrc,dels,qs)

  (qh2oevap,deldevap) = isomixline(q0,del0,qs,dels,nn,eta)
  print ("isomixline 1 =================")
  print ("dels going to isomixline was ", dels)
  print ("qh2oevap ends = ",qh2oevap[0],qh2oevap[-1])
  print ("deldevap ends = ",deldevap[0],deldevap[-1])
#
# Mix between high latitude and tropical super-depleted points
# 
  (qh2omix,deldmix) = isomixline(q0,del0,qs,delp,nn,eta)
  print ("isomixline 2 =================")
  print ("delp going to isomixline was ", delp)
  print ("qh2omix ends = ",qh2omix[0],qh2omix[-1])
  print ("deldmix ends = ",deldmix[0],deldmix[-1])
#
...
#
  ...
  print ("isoraysat 1 =================")
  print ("qh2oray ends = ",qh2oray[0],qh2oray[-1])
  print ("deldray ends = ",deldray[0],deldray[-1])
#
...
#
  ...
  print ("isoraysat 2 =================")
  print ("qh2orev ends = ",qh2orev[0],qh2orev[-1])
  print ("deldrev ends = ",deldrev[0],deldrev[-1])
#
...
# CCD: Change arg-3 to q0/1000.
  ...
  print ("isoeqlsat =================")
  print ("qh2oeql ends = ",qh2oeql[0],qh2oeql[-1])
  print ("deldeql ends = ",deldeql[0],deldeql[-1])
#
...
# CCD: curve is supposed to go from freezing down. Change arg-3 to q0/1000.
  ...
  print ("isoraysat 3 =================")
  print ("qh2oice ends = ",qh2oice[0],qh2oice[-1])
  print ("deldice ends = ",deldice[0],deldice[-1])
...
# Check if there are variable assignments on command line or the name of
# a file of Python assignments to be executed before doing noone_curves.

for s in sys.argv[1:]:
  if '=' in s: exec(s)
  else: exec(open(s,"r").read())

noone_curves(tsrc,q0,del0)    # Run and produce plot

# dump all the variable parameters used ... optional ...
if dump_parms:
  vnames=['hdo', 'h218o', 'conventional', 'eff', 'noice', 'tfreeze', 'vh2ovhdo',
  'del0', 'delp', 'eta', 'hsrc', 'nn', 'pcld', 'ps', 'q0', 'qmin', 'tsrc']
