...
dump_parms = False  # set to False to prevent parameter dump at end
...
#ED: read in and plot some data:
# read in tes netcdf
#tes_ds = xr.open_dataset('/Users/ellendyer/Documents/GitHub/Isotopes_F4R/lite_processed/all_tes_cb.nc')
#tes_ds = xr.open_dataset('/Users/ellendyer/Documents/GitHub/Isotopes_F4R/iso_prepped/tropess_airs_cb.nc')
tes_ds = xr.open_dataset('/Users/ellendyer/Documents/GitHub/Isotopes_F4R/iso_prepped/all_tes_cb_007.nc')
print(tes_ds)
