; See CCD notes for some python equivalents ...
;+
;
...
;
  ...
  ; In this case findgen(npts) --> 0,1,2,3,...,(npts-1) so then
  ; findgen(npts)/(npts-1) --> 0,...,1 with each sequence has npts items
  ; CCD Is this a fair replacement? better to give dtype explicitly ...
