...
# Open file.
#FOLDER = "/Users/ellendyer/Desktop/lite007/"
FOLDER = "/Volumes/ESA_F4R/TL2HDOLN_7-20260109_175030/"
#TES-Aura_L2-HDO-Nadir_2004-08_v007_Lite-v02.00.nc

#arr = os.listdir(FOLDER)

arr = glob.glob(FOLDER+'TES-*.nc')
print(arr)
...
tes_ds = tes_ds.where((tes_ds.lat < 12.) & (tes_ds.lat > 5.),drop=True)
tes_ds = tes_ds.where((tes_ds.lon < 31.) & (tes_ds.lon > 10.),drop=True)

# write out dataset to netcdf
tes_ds.to_netcdf(path='/Users/ellendyer/Documents/GitHub/Isotopes_F4R/iso_prepped/tes_n_cb_007.nc',mode='w',format='NETCDF4',engine='netcdf4')
