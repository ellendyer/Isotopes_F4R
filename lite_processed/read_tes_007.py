...
tes_ds = tes_ds.where((tes_ds.lat < -5.) & (tes_ds.lat > -15.),drop=True)
tes_ds = tes_ds.where((tes_ds.lon < 31.) & (tes_ds.lon > 12.),drop=True)

# write out dataset to netcdf
tes_ds.to_netcdf(path='/Users/ellendyer/Documents/GitHub/Isotopes_F4R/iso_prepped/tes_s_cb_007.nc',mode='w',format='NETCDF4',engine='netcdf4')
